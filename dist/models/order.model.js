        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get The Order with id = ".concat(id, " ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        connection.release();
                        return [2 /*return*/, "DELETED order With id = ".concat(id, " Successfully")];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("\n      Unable to Delete order with id =  ".concat(id, ": ").concat(err_4.message, "\n      "));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Unable to Update Order with The id = ".concat(order.id));
                    case 4: return [2 /*return*/];
                }
            });
        });
