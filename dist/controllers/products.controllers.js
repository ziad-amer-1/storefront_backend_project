...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.show(req.params.productId)];
            case 1:
                product = _a.sent();
                res.status(200).json({
                    data: product,
...
var remove = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deletedProductMessage, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.delete(req.params.productId)];
            case 1:
                deletedProductMessage = _a.sent();
                res.json({
...
var update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.update(req.body)];
            case 1:
                product = _a.sent();
                res.json({
                    data: product,
