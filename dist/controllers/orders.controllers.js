...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.show(req.params.orderId)];
            case 1:
                order = _a.sent();
                res.status(200).json({
                    data: order,
...
var remove = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deletedOrderMessage, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.delete(req.params.orderId)];
            case 1:
                deletedOrderMessage = _a.sent();
                res.json({
...
var update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.update(req.body)];
            case 1:
                order = _a.sent();
                res.json({
                    data: order,
